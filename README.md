...
> Demo项目部署在heroku上，配置文件为手动导入。heroku上的项目，后台是无法修改配置功能的。前台的全部功能，建议后台登陆为管理员后测试使用。离线下载需要配合aria2使用。需要你在本地电脑，或vps上安装aria2。关于离线下载的使用建议了解aria2。Demo项目，为dev分支，为正在开发中版本。
...
- 全局搜索/当前页搜索 
- 删除/新建/上传/重命名/复制/剪切等，基本的onedrive文件操作。仅管理员可用
- aria2离线上传
